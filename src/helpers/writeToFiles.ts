...
export async function resultsToHDD(dir: string, fileName: string, fujiResults: JSON | string) {
...
export async function uploadFromMemory(fileName: string, fujiResults: Buffer) {
    /* DEBUG CODE
